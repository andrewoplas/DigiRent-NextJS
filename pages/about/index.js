...
const index = () => {
	return (
		<PageWrapper title="DigiRent - About Us">
					...
					<div className="main-box">
						<div className="about-us-item">
							...
							<p className="main-desc">
								...
								than ever before by using digitalization as a form to bring down cost for all
								parties. Why don't use technology where it's intended for, to make our life easier
								and with less costs!
							</p>
						</div>
					</div>
					...
					<div className="main-box">
						<div className="about-us-item">
							...
							<p className="main-desc">
								...
								technologies and products. And we make sure they have the opportunity to work with
								it, so they have the freedom to optimize their workflows, operate at the pinnacle of
				...
				<div className="help-build-the-future-wrapper">
					...
					<div className="main-box">
						<p className="main-desc text-center">
							<span className="text-primary">Digi Rent</span> is always looking for new talent for
							our team. We are looking for curious individuals with good ideas and strong opinions
							who, very importantly, can create cool products and help us with our future endeavors.
						</p>
					</div>
					...
					<button className="button btn-view-all-vacancies">
