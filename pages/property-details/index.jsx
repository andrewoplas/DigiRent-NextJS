...
const houseInsides = [
  ...
  { id: 2, image: '/images/property-detail-inside-2.jpg' },
  { id: 3, image: '/images/property-detail-inside-3.jpg' },
  { id: 4, image: '/images/property-detail-inside-1.jpg' },
  ...
  <div className="container max-width property-detail mt-3 mt-md-5">
    <div className="row">
      <div className="col-12 col-xl-7">
        ...
        <Slider {...houseInsidesSettings} className="house-insides mt-4">
